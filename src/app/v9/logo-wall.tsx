...
function MarqueeRow({ logos, reverse = false }: { logos: Logo[]; reverse?: boolean }) {
  ...
  return (
    <div className={`v9-logos-row${reverse ? ' reverse' : ''}`}>
      <div className='v9-logos-track'>
        {doubled.map((l, i) => (
...
export function LogoWall() {
  return (
    <section className='v9-logos-wrap'>
      <div className='v9-container'>
        <div className='v9-logos-head'>
          <h2 className='v9-h2'>
            50+ enterprises. <span className='accent'>6 countries.</span> Shipped.
          </h2>
          <p className='v9-lead'>
            A decade of delivery across financial services, logistics, government, manufacturing,
            retail, and health. Every logo below sits on a system we built, shipped, and run.
          </p>
        </div>
      </div>

      <div className='v9-logos-marquee'>
