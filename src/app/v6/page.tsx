...
export default function V6Page() {
  return (
    <>
      {/* ====== MASTHEAD ====== */}
      <header className='v6-masthead v6-container'>
        <div className='v6-masthead-top'>
        ...
        <nav className='v6-nav'>
          ...
          <a href='#contact' className='v6-nav-cta'>
            Get an assessment
          </a>
        </nav>
        <div className='v6-rule-triple'>
          <span />
        </div>
      </header>

      {/* ====== HERO ====== */}
      <section className='v6-hero v6-container'>
        <div className='v6-hero-kicker'>Human-Led · Agent-Operated · Data-Powered</div>
        <h1>
          Your enterprise. <em>Agent-operated.</em> Starting now.
        </h1>
        <div className='v6-hero-standfirst'>
        ...
        <div className='v6-hero-byline'>
          <a href='#contact' className='v6-btn v6-btn-accent'>
            Get an architecture assessment →
          </a>
          <a href='#contact' className='v6-link'>
            Or talk to our team
          </a>
        </div>
        <div className='v6-hero-caption'>Fig. 01 — The Frontier Organisation, front page</div>
      </section>

      {/* ====== TRUST STRIP ====== */}
      <section className='v6-container'>
        <div className='v6-trust'>
          <div className='v6-trust-label'>
            Trusted by 50+ enterprises across 6 countries
          </div>
          <div className='v6-trust-roster'>
      ...
      <section className='v6-container'>
        <div className='v6-stats'>
          {stats.map((s) => (
            <div key={s.label} className='v6-stat'>
              <div className='v6-stat-figure'>{s.figure}</div>
      ...
      {/* ====== THE AI GAP ====== */}
      <section className='v6-section v6-feature v6-container' id='solutions'>
        <div className='v6-section-head'>
          <div>
            <div className='v6-kicker'>Feature · The AI Gap</div>
            <h2 className='v6-h2'>
              The AI gap every enterprise hits. <em>And how we close it.</em>
            </h2>
          </div>
          <p className='v6-dropcap'>
        ...
        <div className='v6-cap-grid'>
          {capabilities.map((cap) => (
            <article key={cap.num} className='v6-cap-item'>
              <div className='v6-cap-num'>{cap.num}</div>
              <div className='v6-cap-body'>
        ...
        <div className='v6-feature-badge'>▲ The Frontier Organisation</div>
      </section>

      {/* ====== TRANSFORMATION STACK ====== */}
      <section className='v6-section v6-stack v6-container'>
        <div className='v6-section-head'>
          <div>
            <div className='v6-kicker'>Chart · The Transformation Stack</div>
            <h2 className='v6-h2'>
        ...
        <div className='v6-chart'>
          <div className='v6-chart-head'>
            <div>Layer</div>
            <div>Platforms & Capabilities</div>
          </div>
          {stack.map((row) => (
            <div key={row.num} className='v6-chart-row'>
              <div className='v6-chart-label'>
                <span className='num'>{row.num}</span>
                {row.label}
              </div>
              <div className='v6-chart-content'>
                {row.entries.map((e) => (
                  <div key={e.strong} className='v6-chart-entry'>
      ...
      {/* ====== PROVEN ====== */}
      <section className='v6-section v6-container' id='work'>
        <div className='v6-section-head'>
          <div>
            <div className='v6-kicker'>Evidence · Case Studies</div>
            <h2 className='v6-h2'>
              Proven <em>where it matters.</em>
            </h2>
            <p className='v6-lead' style={{ marginTop: 20 }}>
        ...
        {/* By industry */}
        <div className='v6-proven-group'>
          <div className='v6-proven-label'>By Industry</div>
          <div className='v6-case-grid'>
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Financial Services</span>
                <span className='v6-case-figure'>38% faster</span>
              </div>
            ...
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Logistics & Fleet</span>
                <span className='v6-case-figure'>$14M saved</span>
              </div>
            ...
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Aged Care</span>
                <span className='v6-case-figure'>6× throughput</span>
              </div>
        ...
        {/* By solution */}
        <div className='v6-proven-group'>
          <div className='v6-proven-label'>By Solution</div>
          <div className='v6-case-grid'>
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>FactWeavers™</span>
                <span className='v6-case-figure'>11 domains</span>
              </div>
            ...
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Agent Studio</span>
                <span className='v6-case-figure'>40+ agents</span>
              </div>
            ...
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>DBiz Canvas</span>
                <span className='v6-case-figure'>5 days</span>
              </div>
        ...
        {/* By technology */}
        <div className='v6-proven-group'>
          <div className='v6-proven-label'>By Technology</div>
          <div className='v6-case-grid cols-4'>
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Cloud & AI</span>
                <span className='v6-case-figure'>40+</span>
              </div>
              <h4>AWS · Azure · GCP</h4>
              <p>
            ...
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Data Platforms</span>
                <span className='v6-case-figure'>Core</span>
              </div>
            ...
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Integration</span>
                <span className='v6-case-figure'>iPaaS</span>
              </div>
            ...
            <article className='v6-case'>
              <div className='v6-case-meta'>
                <span className='v6-case-sector'>Business Apps</span>
                <span className='v6-case-figure'>200+</span>
              </div>
      ...
      {/* ====== PULL QUOTE ====== */}
      <section className='v6-pullquote'>
      ...
      {/* ====== HOW WE WORK ====== */}
      <section className='v6-section v6-container'>
        <div className='v6-section-head'>
          <div>
            <div className='v6-kicker'>Cadence · How We Work</div>
            <h2 className='v6-h2'>
        ...
        <div className='v6-cadence-grid'>
          <div className='v6-cadence-step'>
            <div className='v6-cadence-days'>
              5<sup>Days</sup>
            </div>
            <h4>Align & Assess</h4>
            <p>
      ...
      {/* ====== WHY DBIZ ====== */}
      <section className='v6-section v6-container' id='about'>
        <div className='v6-section-head'>
          <div>
            <div className='v6-kicker'>Op-ed · Why DBiz</div>
            <h2 className='v6-h2'>
        ...
        <div className='v6-why-grid'>
          <div className='v6-why-item'>
        ...
        <div className='v6-partners-row'>
          <div className='v6-partners-col'>
      ...
      {/* ====== FOOTER ====== */}
      <footer className='v6-footer' id='careers'>
        <div className='v6-container'>
          <div className='v6-foot-top'>
            <div className='v6-foot-brand'>
